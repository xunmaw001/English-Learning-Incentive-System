<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="奖励编号" prop="jianglibianhao">
            <el-input v-model="ruleForm.jianglibianhao" 
                placeholder="奖励编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianglibianhao" label="奖励编号" prop="jianglibianhao">
              <el-input v-model="ruleForm.jianglibianhao" 
                placeholder="奖励编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖励标题" prop="jianglibiaoti">
          <el-input v-model="ruleForm.jianglibiaoti" 
              placeholder="奖励标题" clearable  :readonly="ro.jianglibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖励标题" prop="jianglibiaoti">
              <el-input v-model="ruleForm.jianglibiaoti" 
                placeholder="奖励标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="奖励机制" prop="jianglijizhi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianglijizhi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianglijizhi" label="奖励机制" prop="jianglijizhi">
                    <span v-html="ruleForm.jianglijizhi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jianglijizhi : false,
      ...
      rules: {
          ...
          jianglijizhi: [
                { required: true, message: '奖励机制不能为空', trigger: 'blur' },
  ...
  methods: {
	...
	this.ruleForm.jianglijizhi = this.ruleForm.jianglijizhi.replace(reg,'../../../ssm65k27/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianglijizhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianglijizhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
